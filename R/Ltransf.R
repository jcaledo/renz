...
ecb <- function(data, unit_S = 'mM', unit_v = 'au', plot = TRUE){
  ...
  fitted_parameters <- c(round(mean(Kms), 3),  round(mean(Vms), 3))
  names(fitted_parameters) <- c('Km', 'Vm')
