...
#                            int.MM(data)                                           #
## ------------------------------------------------------------------------------- ##
#' Linearization of The Integrated Michaelis-Mente Equation
#' @description Estimates the kinetic parameters using an linearized form of the integrated Michaelins-Menten equation.
...
#' @detail The r-squared value of the model can be checked using attributes().
