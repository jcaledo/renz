...
#' @param plot logical. If true, the data and fitted cuve are plotted.
#' @detail .
#' @return A list of two elements. The first one is a vector containing the enzyme kinetic parameters. The socond one is a dataframe with the original data plus the fitted value of v.
